    ...
    <div>
      <el-row>
        <el-col :span="24" class="warp-breadcrum">
          <el-breadcrumb separator="/">
            <el-breadcrumb-item style="font-size: 20px">设备用途</el-breadcrumb-item>
          </el-breadcrumb>
        </el-col>
      </el-row>
      ...
      <el-col :span="18" :class="this.Global.pageToolBarClass" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          <el-form-item>
            <el-input v-model="filters.TYPE_CODE" placeholder="分类码"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-col :span="24" style="padding-bottom: 0px;">
          ...
          <el-table-column prop="TYPE_CODE" label="分类码" align="center">
            <template slot-scope="scope">
              <el-input v-model="scope.row.TYPE_CODE"></el-input>
            </template>
          </el-table-column>
          <el-table-column prop="TYPE_NAME" label="名称" align="center" min-width="100">
            <template slot-scope="scope">
...
<script>
    ...
    methods: {
      ...
      handleExp2XLSData() {
        ...
        require.ensure([], () => {
          ...
          export_json_to_excel(tHeader, data, '设备用途')
        })
      },
  ...
  SaveData: function () {
    let self = this
    self.$ajax.get('eqpapi/S_EQP001', {
        params:{
          EQP001DataS:JSON.stringify(self.dataList),
          DelEQP001S:JSON.stringify(self.deleteRow)
        }
      }
    ).then(
      function (res) {
  ...
  showDatas: function () {
    let self = this
    self.$ajax.get('eqpapi/Q_EQP001').then(
      function (response) {
