    ...
    <div>
      <el-row>
        <el-col :span="24" class="warp-breadcrum">
          <el-breadcrumb separator="/">
            <el-breadcrumb-item style="font-size: 20px">故障分类</el-breadcrumb-item>
          </el-breadcrumb>
        </el-col>
      </el-row>
      ...
      <el-col :span="18" :class="this.Global.pageToolBarClass" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          <el-form-item>
            <el-input v-model="filters.FAULT_CODE" placeholder="故障代码"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-col :span="24" style="padding-bottom: 0px;">
        ...
        <el-table-column prop="FAULT_CODE" label="故障代码" align="center">
          <template slot-scope="scope">
            <el-input v-model="scope.row.FAULT_CODE"></el-input>
          </template>
        </el-table-column>
        <el-table-column prop="FAULT_NAME" label="名称" align="center" min-width="100">
          <template slot-scope="scope">
            <el-input v-model="scope.row.FAULT_NAME"></el-input>
          </template>
        </el-table-column>
    ...
    methods: {
      ...
      handleExp2XLSData() {
        ...
        require.ensure([], () => {
          ...
          export_json_to_excel(tHeader, data, '故障分类')
        })
      },
      ...
      SaveData: function () {
        let self = this
        self.$ajax.get('eqpapi/S_EQP003', {
            params:{
              EQP003DataS:JSON.stringify(self.dataList),
              DelEQP003S:JSON.stringify(self.deleteRow)
            }
          }
        ).then(
          function (res) {
      ...
      showDatas: function () {
        let self = this
        self.$ajax.get('eqpapi/Q_EQP003').then(
          function (response) {
