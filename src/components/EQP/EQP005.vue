    ...
    <div>
      <el-row>
        <el-col :span="24" class="warp-breadcrum">
          <el-breadcrumb separator="/">
            <el-breadcrumb-item style="font-size: 20px">设备资产状态</el-breadcrumb-item>
          </el-breadcrumb>
        </el-col>
      </el-row>
      ...
      <el-col :span="18" :class="this.Global.pageToolBarClass" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          <el-form-item>
            <el-input v-model="filters.ASSETS_CODE" placeholder="资产状态码"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-col :span="24" style="padding-bottom: 0px;">
        ...
        <el-table-column prop="ASSETS_CODE" label="资产状态码" align="center">
          <template slot-scope="scope">
            <el-input v-model="scope.row.ASSETS_CODE"></el-input>
          </template>
        </el-table-column>
        <el-table-column prop="ASSETS_NAME" label="名称" align="center" min-width="100">
          <template slot-scope="scope">
            <el-input v-model="scope.row.ASSETS_NAME"></el-input>
          </template>
        </el-table-column>
    ...
    methods: {
      ...
      handleExp2XLSData() {
        ...
        require.ensure([], () => {
          ...
          export_json_to_excel(tHeader, data, '设备资产状态')
        })
      },
      ...
      SaveData: function () {
        let self = this
        self.$ajax.get('eqpapi/S_EQP005', {
            params:{
              EQP005DataS:JSON.stringify(self.dataList),
              DelEQP005S:JSON.stringify(self.deleteRow)
            }
          }
        ).then(
          function (res) {
      ...
      showDatas: function () {
        let self = this
        self.$ajax.get('eqpapi/Q_EQP005').then(
          function (response) {
