    ...
    <div>
      <el-row>
        <el-col :span="24" class="warp-breadcrum">
          <el-breadcrumb separator="/">
            <el-breadcrumb-item style="font-size: 20px">设备位置</el-breadcrumb-item>
          </el-breadcrumb>
        </el-col>
      </el-row>
      ...
      <el-col :span="18" :class="this.Global.pageToolBarClass" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          <el-form-item>
            <el-input v-model="filters.LOCATE_CODE" placeholder="设备位置编码"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-col :span="24" style="padding-bottom: 0px;">
        ...
        <el-table-column prop="LOCATE_CODE" label="位置编码" align="center">
          <template slot-scope="scope">
            <el-input v-model="scope.row.LOCATE_CODE"></el-input>
          </template>
        </el-table-column>
        <el-table-column prop="LOCATE_NAME" label="名称" align="center" min-width="100">
          <template slot-scope="scope">
            <el-input v-model="scope.row.LOCATE_NAME"></el-input>
          </template>
        </el-table-column>
    ...
    methods: {
      ...
      handleExp2XLSData() {
        ...
        require.ensure([], () => {
          ...
          export_json_to_excel(tHeader, data, '设备位置')
        })
      },
      ...
      SaveData: function () {
        let self = this
        self.$ajax.get('eqpapi/S_EQP006', {
            params:{
              EQP006DataS:JSON.stringify(self.dataList),
              DelEQP006S:JSON.stringify(self.deleteRow)
            }
          }
        ).then(
          function (res) {
      ...
      showDatas: function () {
        let self = this
        self.$ajax.get('eqpapi/Q_EQP006').then(
          function (response) {
