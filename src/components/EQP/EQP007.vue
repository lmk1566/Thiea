    ...
    <div>
      <el-row>
        <el-col :span="24" class="warp-breadcrum">
          <el-breadcrumb separator="/">
            <el-breadcrumb-item style="font-size: 20px">维保分类</el-breadcrumb-item>
          </el-breadcrumb>
        </el-col>
      </el-row>
      ...
      <el-col :span="18" :class="this.Global.pageToolBarClass" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          <el-form-item>
            <el-input v-model="filters.MAINT_CODE" placeholder="维保分类码"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-col :span="24" style="padding-bottom: 0px;">
        ...
        <el-table-column prop="MAINT_CODE" label="维保分类编码" align="center">
          <template slot-scope="scope">
            <el-input v-model="scope.row.MAINT_CODE"></el-input>
          </template>
        </el-table-column>
        <el-table-column prop="MAINT_NAME" label="名称" align="center" min-width="100">
          <template slot-scope="scope">
            <el-input v-model="scope.row.MAINT_NAME"></el-input>
          </template>
        </el-table-column>
    ...
    methods: {
      ...
      handleExp2XLSData() {
        ...
        require.ensure([], () => {
          ...
          export_json_to_excel(tHeader, data, '维保分类')
        })
      },
      ...
      SaveData: function () {
        let self = this
        self.$ajax.get('eqpapi/S_EQP007', {
            params:{
              EQP007DataS:JSON.stringify(self.dataList),
              DelEQP007S:JSON.stringify(self.deleteRow)
            }
          }
        ).then(
          function (res) {
      ...
      showDatas: function () {
        let self = this
        self.$ajax.get('eqpapi/Q_EQP007').then(
          function (response) {
