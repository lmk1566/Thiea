  ...
  <section>
      <el-row>
        <el-col :span="24" class="warp-breadcrum">
          <el-breadcrumb separator="/">
            <el-breadcrumb-item style="font-size: 20px">点巡检分类</el-breadcrumb-item>
          </el-breadcrumb>
        </el-col>
      </el-row>
      ...
      <el-col :span="18" :class="this.Global.pageToolBarClass" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          <el-form-item>
            <el-input v-model="filters.PATROL_CODE" placeholder="点巡检分类码"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-col :span="24" style="padding-bottom: 0px;">
        <el-table
          ...
          <el-table-column prop="PATROL_CODE" label="点巡检分类编码" align="center">
            <template slot-scope="scope">
              <el-input v-model="scope.row.PATROL_CODE"></el-input>
            </template>
          </el-table-column>
          <el-table-column prop="PATROL_NAME" label="名称" align="center" min-width="100">
            <template slot-scope="scope">
              <el-input v-model="scope.row.PATROL_NAME"></el-input>
            </template>
          </el-table-column>
    ...
    methods: {
      ...
      handleExp2XLSData() {
        ...
        require.ensure([], () => {
          ...
          export_json_to_excel(tHeader, data, '点巡检分类')
        })
      },
      ...
      SaveData: function () {
        let self = this
        self.$ajax.get('eqpapi/S_EQP008', {
            params:{
              EQP008DataS:JSON.stringify(self.dataList),
              DelEQP008S:JSON.stringify(self.deleteRow)
            }
          }
        ).then(
          function (res) {
      ...
      showDatas: function () {
        let self = this
        self.$ajax.get('eqpapi/Q_EQP008').then(
          function (response) {
