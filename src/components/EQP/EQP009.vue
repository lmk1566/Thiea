    ...
    <div>
      <el-col :span="24" class="warp-breadcrum">
        <el-breadcrumb separator="/">
          <el-breadcrumb-item style="font-size: 20px">备件分类</el-breadcrumb-item>
        </el-breadcrumb>
      </el-col>
      ...
      <el-col :span="18" :class="this.Global.pageToolBarClass" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          <el-form-item>
            <el-input v-model="filters.PATRS_CODE" placeholder="备件分类码"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-col :span="24" style="padding-bottom: 0px;">
        ...
        <el-table-column prop="PATRS_CODE" label="备件分类码" align="center">
          <template slot-scope="scope">
            <el-input v-model="scope.row.PATRS_CODE"></el-input>
          </template>
        </el-table-column>
        <el-table-column prop="PATRS_NAME" label="名称" align="center" min-width="100">
          <template slot-scope="scope">
    ...
    methods: {
      ...
      handleExp2XLSData() {
        ...
        require.ensure([], () => {
          ...
          export_json_to_excel(tHeader, data, '备件分类')
        })
      },
      ...
      SaveData: function () {
        let self = this
        self.$ajax.get('eqpapi/S_EQP009', {
            params:{
              EQP009DataS:JSON.stringify(self.dataList),
              DelEQP009S:JSON.stringify(self.deleteRow)
            }
          }
        ).then(
          function (res) {
      ...
      showDatas: function () {
        let self = this
        self.$ajax.get('eqpapi/Q_EQP009').then(
          function (response) {
