    ...
    <div>
      <el-col :span="24" class="warp-breadcrum">
        <el-breadcrumb separator="/">
          <el-breadcrumb-item style="font-size: 20px">零部件分类</el-breadcrumb-item>
        </el-breadcrumb>
      </el-col>
...
<script>
  export default {
    ...
    methods: {
      ...
      SaveData: function () {
        let self = this
        self.$ajax.get('eqpapi/S_EQP011', {
            params:{
              EQP011DataS:JSON.stringify(self.dataList),
              DelEQP011S:JSON.stringify(self.deleteRow)
            }
          }
        ).then(
          function (res) {
      ...
      showDatas: function () {
        let self = this
        self.$ajax.get('eqpapi/Q_EQP011').then(
          function (response) {
