    ...
    <div>
      <el-col :span="24" class="warp-breadcrum">
        <el-breadcrumb separator="/">
          <el-breadcrumb-item style="font-size: 20px">设备类型</el-breadcrumb-item>
        </el-breadcrumb>
      </el-col>
      ...
      <el-col :span="17" :class="this.Global.pageToolBarClass" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          <el-form-item>
            <el-input v-model="filters.MACHINE_TYPE" placeholder="设备类型码"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-col :span="24" style="padding-bottom: 0px;">
        <el-table
          ...
          <el-table-column prop="MACHINE_TYPE" label="设备类型码" align="center" sortable>
            <template slot-scope="scope">
              <el-input v-model="scope.row.MACHINE_TYPE"></el-input>
            </template>
          </el-table-column>
          <el-table-column prop="TYPE_NAME" label="名称" align="center" sortable>
            <template slot-scope="scope">
              <el-input v-model="scope.row.TYPE_NAME"></el-input>
            </template>
          </el-table-column>
...
<script>
  export default {
    ...
    methods: {
      ...
      SaveData: function () {
        let self = this
        self.$ajax.get('eqpapi/S_EQP016', {
            params:{
              EQP016DataS:JSON.stringify(self.dataList),
              DelEQP016S:JSON.stringify(self.deleteRow)
            }
          }
        ).then(
          function (res) {
      ...
      showDatas: function () {
        let self = this
        self.$ajax.get('eqpapi/Q_EQP016').then(
          function (response) {
