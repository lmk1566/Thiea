  ...
  <section>
    ...
    <el-col :span="24" class="warp-breadcrum">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item style="font-size: 20px">设备台账</el-breadcrumb-item>
      </el-breadcrumb>
    </el-col>
    ...
    <el-col :span="18" :class="this.Global.pageToolBarClass" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters">
        <el-form-item>
          <el-select v-model="filters.device_no" placeholder="请选择设备编号" clearable filterable>
            <el-option
        ...
        <el-form-item>
          <el-select v-model="filters.device_no" placeholder="请选择资产编号" clearable filterable>
            <el-option
              v-for="item in devicesAllList"
              :key="item.id"
              :label="item.asset_no"
    ...
    <el-table :data="resultData" highlight-current-row  border v-loading="listLoading"
      ...
      <el-table-column prop="device_no" label="设备编号" header-align="center"
                       align="center" sortable width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
          {{ scope.row.device_no }}
        </template>
      </el-table-column>
      <el-table-column prop="device_name" label="设备名称" header-align="center"
                       align="left" width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
          {{ scope.row.device_name }}
        </template>
      </el-table-column>
      <el-table-column prop="machine_name" label="设备类型" header-align="center"
                       align="center" width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
          {{ scope.row.machine_name }}
        </template>
      </el-table-column>
      <el-table-column prop="asset_no" label="资产编号" header-align="center"
                       align="center" width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
          {{ scope.row.asset_no }}
        </template>
      </el-table-column>
      <el-table-column prop="device_fmt" label="规格型号" header-align="center"
                       align="center" width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
      ...
      <el-table-column prop="type_name" label="设备用途" header-align="center"
                       align="center" width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
          {{ scope.row.type_name }}
        </template>
      </el-table-column>
      <el-table-column prop="assets_name" label="资产状态" header-align="center"
                       align="center" width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
          {{ scope.row.assets_name }}
        </template>
      </el-table-column>
      <el-table-column prop="status_name" label="工作状态" header-align="center"
                       align="center" width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
      ...
      <el-table-column prop="locate_name" label="安装位置" header-align="center"
                       align="center" width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
          {{ scope.row.locate_name }}
        </template>
      </el-table-column>
      <el-table-column prop="depreciation" label="折旧年限" header-align="center"
                       align="center" width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
          {{ scope.row.depreciation }}
        </template>
      </el-table-column>
      <el-table-column prop="orig_value" label="设备原值" header-align="center"
                       align="center" width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
          ...
          <el-form :model="editForm" label-width="100px" :rules="editFormRules" ref="editForm" style="margin:-20px -20px -20px -20px; border:#DCDFE6 1px solid;">
            <el-row class="elTableRowHeight">
              <el-col :span="8">
                ...
                <el-form-item label="设备编号" prop="device_no" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.device_no"
                            placeholder="设备编号" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="14">
                <el-form-item label="设备名称" prop="device_name" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.device_name"
                            placeholder="设备名称" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row class="elTableRowHeight">
              <el-col :span="8">
                ...
                <el-form-item label="设备类型" prop="machine_name" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.machine_name"
                            placeholder="设备类型" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="14">
                <el-form-item label="资产编号" prop="asset_no" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.asset_no"
                            placeholder="资产编号" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="8">
                <el-form-item label="规格型号" prop="device_fmt" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.device_fmt"
                            placeholder="规格型号" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="14">
                <el-form-item label="单位" prop="unit" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.unit"
                            placeholder="单位" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="8">
                <el-form-item  prop="eqp001_id" v-if="false"><el-input v-model="editForm.eqp001_id" v-if="false"></el-input></el-form-item>
                <el-form-item label="设备用途" prop="type_name" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.type_name"
                            placeholder="设备用途" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="14">
                <el-form-item  prop="eqp005_id" v-if="false"><el-input v-model="editForm.eqp005_id" v-if="false"></el-input></el-form-item>
                <el-form-item label="资产状态" prop="assets_name" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.assets_name"
                            placeholder="资产状态" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="8">
                <el-form-item  prop="eqp002_id" v-if="false"><el-input v-model="editForm.eqp002_id" v-if="false"></el-input></el-form-item>
                <el-form-item label="工作状态" prop="status_name" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.status_name"
                            placeholder="工作状态" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="14">
                <el-form-item label="制造厂商" prop="manufactor" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.manufactor"
                            placeholder="制造厂商" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="8">
                <el-form-item label="制造日期" prop="manufact_date" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.manufact_date"
                            placeholder="制造日期" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="14">
                <el-form-item label="出厂编号" prop="manufact_no" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.manufact_no"
                            placeholder="出厂编号" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="8">
                <el-form-item label="进厂日期" prop="enter_date" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.enter_date"
                            placeholder="进厂日期" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="14">
                <el-form-item label="安装日期" prop="setup_date" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.setup_date"
                            placeholder="安装日期" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="8">
                <el-form-item  prop="eqp006_id" v-if="false"><el-input v-model="editForm.eqp006_id" v-if="false"></el-input></el-form-item>
                <el-form-item label="验收日期" prop="accept_date" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.accept_date"
                            placeholder="验收日期" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="14">
                <el-form-item label="安装位置" prop="setup_date" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.setup_date"
                            placeholder="安装日期" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="折旧年限" prop="depreciation" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.depreciation"
                            placeholder="折旧年限" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="14">
                <el-form-item label="设备原值" prop="orig_value" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.orig_value"
                            placeholder="设备原值" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
