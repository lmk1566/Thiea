    ...
    <div>
      <el-col :span="24" class="warp-breadcrum">
        <el-breadcrumb separator="/">
          <el-breadcrumb-item style="font-size: 20px">备件库存</el-breadcrumb-item>
        </el-breadcrumb>
      </el-col>
      ...
      <el-col :span="17" :class="this.Global.pageToolBarClass" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          <el-form-item>
            <el-input v-model="filters.SPARE_CODE" placeholder="分类码"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-col :span="24" style="padding-bottom: 0px;">
        <el-table
          ...
          <el-table-column prop="SPARE_CODE" label="零部件分类码" align="center" sortable>
            <template slot-scope="scope">
              <el-input v-model="scope.row.SPARE_CODE"></el-input>
            </template>
          </el-table-column>
          <el-table-column prop="SPARE_NAME" label="名称" align="center" sortable>
            <template slot-scope="scope">
              <el-input v-model="scope.row.SPARE_NAME"></el-input>
            </template>
          </el-table-column>
          ...
          <el-table-column prop="CREATE_DATE" label="维护时间" align="center" sortable>
            <template scope="scope"> {{ scope.row.CREATE_DATE }} </template>
          </el-table-column>
    ...
    methods: {
      ...
      handleExp2XLSData() {
        ...
        require.ensure([], () => {
          ...
          export_json_to_excel(tHeader, data, '零部件分类')
      })
      },
      ...
      SaveData: function () {
        let self = this
        self.$ajax.get('eqpapi/S_EQP034', {
            params:{
              EQP034DataS:JSON.stringify(self.dataList),
              DelEQP034S:JSON.stringify(self.deleteRow)
            }
          }
        ).then(
          function (res) {
      ...
      showDatas: function () {
        let self = this
        self.$ajax.get('eqpapi/Q_EQP034').then(
          function (response) {
