  ...
  <section>
    ...
    <el-col :span="24" class="warp-breadcrum">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item style="font-size: 20px">工序信息</el-breadcrumb-item>
      </el-breadcrumb>
    </el-col>
    ...
    <el-col :span="18" :class="this.Global.pageToolBarClass" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters">
        <el-form-item>
          <el-select v-model="filters.device_no" placeholder="请选择工序编号" clearable filterable>
            <el-option
    ...
    <el-table :data="resultData" highlight-current-row  border v-loading="listLoading"
      ...
      <el-table-column prop="process_no" label="工序编号" header-align="center"
                       align="center" sortable width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
          {{ scope.row.process_no }}
        </template>
      </el-table-column>
      <el-table-column prop="process_name" label="工序名称" header-align="center"
                       align="left" width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
          {{ scope.row.process_name }}
        </template>
      </el-table-column>
      <el-table-column prop="process_type" label="工序类型" header-align="center"
                       align="center" width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
          {{ scope.row.process_type }}
        </template>
      </el-table-column>
      <el-table-column prop="basic_waste" label="基础损耗" header-align="center"
                       align="center" width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
          {{ scope.row.basic_waste }}
        </template>
      </el-table-column>
      <el-table-column prop="std_capacity" label="标准产能" header-align="center"
                       align="center" width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
          {{ scope.row.std_capacity }}
        </template>
      </el-table-column>
      <el-table-column prop="capacity_unit" label="产能单位" header-align="center"
                       align="center" width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
          {{ scope.row.capacity_unit }}
        </template>
      </el-table-column>
      <el-table-column prop="def_processtime" label="默认作业时间" header-align="center"
                       align="center" width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
          {{ scope.row.def_processtime }}
        </template>
      </el-table-column>
      <el-table-column prop="std_processtime" label="标准作业时间" header-align="center"
                       align="center" width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
          {{ scope.row.std_processtime }}
        </template>
      </el-table-column>
      <el-table-column prop="fix_processtime" label="固定作业时间" header-align="center"
                       align="center" width="150px">
        <template slot-scope="scope" style="color: #409EFF; cursor: pointer;">
    ...
    <el-dialog :title="editTitle"  :visible.sync="editFormVisible"  custom-class="elDialogWidth"
      ...
      <el-tabs v-model="activeTabName" type="border-card"
          ...
          <el-form :model="editForm" label-width="130px" :rules="editFormRules" ref="editForm" style="margin:-20px -20px -20px -20px; border:#DCDFE6 1px solid;">
            <el-row class="elTableRowHeight">
              <el-col :span="8">
                ...
                <el-form-item label="工序编号" prop="process_no" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.process_no"
                            placeholder="工序编号" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="14">
                <el-form-item label="工序名称" prop="process_name" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.process_name"
                            placeholder="工序名称" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row class="elTableRowHeight">
              <el-col :span="8">
                ...
                <el-form-item label="工序类型" prop="process_type" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.process_type"
                            placeholder="工序类型" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="14">
                <el-form-item label="基础损耗" prop="basic_waste" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.basic_waste"
                            placeholder="基础损耗" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="标准产能" prop="std_capacity" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.std_capacity"
                            placeholder="标准产能" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="14">
                <el-form-item label="产能单位" prop="capacity_unit" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.capacity_unit"
                            placeholder="产能单位" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="8">
                <el-form-item label="默认作业时间" prop="def_processtime" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.def_processtime"
                            placeholder="默认作业时间" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="14">
                <el-form-item label="标准作业时间" prop="std_processtime" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.std_processtime"
                            placeholder="标准作业时间" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="8">
                <el-form-item label="固定作业时间" prop="fix_processtime" :inline-message="true" style="margin-top: 10px;">
                  <el-input v-model="editForm.fix_processtime"
                            placeholder="固定作业时间" maxlength="100" :disabled="editForm.id != 0"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="14">
                <el-form-item label="" prop="chk_fixprocess" :inline-message="true" style="margin-top: 10px;">
                  <el-checkbox @change="handleCheckedCitiesChange"  v-model="editForm.chk_fixprocess" >按固定作业工时计算</el-checkbox>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
        ...
        <el-tab-pane label="设备类型管理" name="tablist">
          <span slot="label"><i class="el-icon-circle-plus"></i>设备类型管理</span>
